...
namespace SkyFight
{
    public class Smoke : Sprite, IAnimatable
    {
        public Smoke(float X, float Y, string texturePath, ContentManager contentManager, float Scale, Biplane biplane) : base(X, Y, texturePath, contentManager, Scale)
        {
